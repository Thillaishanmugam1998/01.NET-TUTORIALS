...
{
    private readonly IRestaurantMessageService _restaurantMessageService;
    ...
    public RestaurantService(IRestaurantMessageService restaurantMessageService)
    {
        // Dependency Injection can also supply one service inside another service.
        _restaurantMessageService = restaurantMessageService;
    }
    ...
    public string GetRestaurantModuleMessage()
    {
        return _restaurantMessageService.GetWelcomeMessage();
    }
