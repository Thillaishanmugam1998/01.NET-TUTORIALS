...
public class RestaurantsController : ControllerBase
{
    ...
    [HttpGet("message")]
    public ActionResult<string> GetRestaurantMessage()
    {
        // This endpoint shows that service-to-service DI is also working.
        var message = _restaurantService.GetRestaurantModuleMessage();
        return Ok(message);
    }
