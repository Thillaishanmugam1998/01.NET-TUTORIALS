...
using SwiggyAPI.Controllers.API.Models;

namespace SwiggyAPI.Controllers.API.Controllers;
...
public class RestaurantsController : ControllerBase
{
    ...
    {
        // Controller receives request and forwards it to the service layer.
    ...
    [HttpGet("open")]
    public ActionResult<List<Restaurant>> GetOpenRestaurants()
    {
        // Custom route segment "open" is mapped to this action method.
        var openRestaurants = _restaurantService.GetOpenRestaurants();
    ...
    {
        // HTTP PUT updates an existing resource.
