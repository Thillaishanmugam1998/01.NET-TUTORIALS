...
namespace SwiggyAPI.Controllers.API.Implementations;
...
public class RestaurantService : IRestaurantService
{
    ...
    {
        // LINQ helps us search the list with a condition.
        return Restaurants.FirstOrDefault(currentRestaurant => currentRestaurant.Id == restaurantId);
    }

    public List<Restaurant> GetOpenRestaurants()
    {
        // Filters only the restaurants currently available for orders.
